...
public class ExpiringMap<K, V> implements Map<K, V> {
    ...
    public static final class Builder {
        ...
        /**
         * Sets expiration listeners which will receive notifications upon each map entry's
         * expiration.
         * 
    ...
    /**
     * Creates a new instance of ExpiringMap with ExpirationPolicy.CREATED and expiration duration
        ...
        if (entry == null) {
            entry = new ExpiringEntry<K, V>(key, value,
                    variableExpiration ? new AtomicReference<ExpirationPolicy>(expirationPolicy)
                            : this.expirationPolicy, variableExpiration ? new AtomicLong(
                            expirationMillis) : this.expirationMillis);
    ...
    /**
     * Not currently supported. Use this{@link #keySet()} and this{@link #entrySetIterable()}
     * instead.
     * 
     * @throws UnsupportedOperationException
     */
