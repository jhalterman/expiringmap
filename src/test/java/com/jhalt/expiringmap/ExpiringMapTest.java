...
public class ExpiringMapTest extends ConcurrentTestCase {
    ...
    public void testPut() throws Exception {
        Map<String, Integer> map = ExpiringMap.builder().expiration(100, TimeUnit.MILLISECONDS)
                .build();
    ...
    /**
     * Performs 10000 puts in each of 50 threads across 10 maps and ensures that expiration times
     * are within 1/10s of expected times.
     */
    @Test
    @Ignore
    ...
    /**
     * Performs 10000 puts in each of 20 threads across 50 maps and ensures that expiration times
     * are within 1/10s of expected times.
     */
    @Test
    @Ignore
    ...
    /**
     * A test that performs 10000 puts in each of {@code threadCount} threads across
     * {@code mapCount} maps and asserts that expiration times are within 1/10th of a second of the
     * expected times.
     * 
     * <p> Note: Thread puts timeout at 60 seconds.
     */
    ...
    private void putTest(final int threadCount, final int mapCount, final long duration)
        ...
        ExpiringMap.Builder builder = ExpiringMap.builder()
                .expiration(duration, TimeUnit.MILLISECONDS).expirationListener(expirationListener);
    ...
    /**
     * Tests that {@link ExpiringMap#setExpirationPolicy(Object, ExpirationPolicy) works as
     * expected.
     */
    @Test
